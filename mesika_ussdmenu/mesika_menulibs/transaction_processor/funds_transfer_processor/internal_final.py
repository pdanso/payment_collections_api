...
def internal(request, endpoint, bank_code, data, last_position, goback_message, pos):
    ...
    if last_position == "FNDACL":
        ...
        if account_results['status'] == 200:
            account_profile_uuid = account_results['accounts']['account_profile_uuid']
            account_number = account_results['accounts']['account_number']
            is_active = account_results['accounts']['active']
